...
def augment_query_generation(query: str, client: OpenAI, model: str = "gpt-4o") -> str:
    ...
    augmented_query = response.choices[0].message.content
...
def main():
    ...
    hypothetical_answer  = augment_query_generation(query, openai_client)
    # join query and augmented query
    join_query = f"{query} {hypothetical_answer}"
    results = collection.query(
        query_texts=[join_query],
        n_results=TOP_K,
